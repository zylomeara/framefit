...
hands it back inline — 68730 characters, once per session if you park it on a global
...
68730 characters through your context. Keep it for a page whose CSP forbids the `eval` the fetch
