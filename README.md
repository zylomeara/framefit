...
hands it back inline — 61789 characters, once per session if you park it on a global
...
61789 characters through your context. Keep it for a page whose CSP forbids the `eval` the fetch
