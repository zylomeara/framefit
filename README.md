...
hands it back inline — 56022 characters, once per session if you park it on a global
...
56022 characters through your context. Keep it for a page whose CSP forbids the `eval` the fetch
