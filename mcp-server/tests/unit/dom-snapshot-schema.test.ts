...
const okSnapshot = {
  schema: 7, status: 'ok', selector: '.reason', innerWidth: 375,
...
describe('DomSnapshotSchema', () => {
  ...
  it('v5: DomChild accepts the style bundle (radius/gradient/shadow/borders/data)', () => {
    const snap = { schema: 7, innerWidth: 100, rect: { x: 0, y: 0, w: 10, h: 10 },
...
describe('gradient schema', () => {
  it('version bumped to 7 (paint honesty)', () => { expect(DOM_SNAPSHOT_SCHEMA_VERSION).toBe(7); });
  it('accepts a valid gradient in styles', () => {
    const snap = { schema: 7, status: 'ok', innerWidth: 1200, rect: { x:0,y:0,w:10,h:10 },
      borders: { top:0,right:0,bottom:0,left:0 }, scroll: { top:0,left:0 }, children: [],
  ...
  it('rejects gradient without kind', () => {
    const bad = { schema: 7, status: 'ok', innerWidth: 1, rect:{x:0,y:0,w:1,h:1}, borders:{top:0,right:0,bottom:0,left:0}, scroll:{top:0,left:0}, children:[],
