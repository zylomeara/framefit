...
export const InputSchema = {
  ...
  dom_ref: DomRefSchema.optional().describe(
    ...
    'whole-frame DOM JSON - moves a large snapshot off the MCP wire onto the direct upload. HTTP deployments ' +
    'and stdio\'s loopback browser sidecar construct the snapshot store this resolves against; if the stdio ' +
    'sidecar is unavailable, pass dom_snapshot inline. ref = the ' +
