...
export const SERVER_INSTRUCTIONS = [
  ...
  'a depth-ceiling tail) — verify those by eye, then you may proceed; ❌ rows or',
  '`omitted_pair_ids` are discrepancies to fix first, whatever `blocking[]` says. The cycle is stated once in',
