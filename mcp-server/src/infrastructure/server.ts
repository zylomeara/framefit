...
export const SERVER_INSTRUCTIONS = [
  ...
  '`blocking[]` means only inherent caveats remain (demotes, out-of-reach axes, a depth-ceiling',
  'tail) — verify those by eye, then you may proceed. The cycle is stated once in',
